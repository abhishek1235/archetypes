...
define(["jquery"], function ($) {
    ...
    NavBar.prototype.init = function () {
        var self = this,
            ...
            //navType = "navbar-" + self.widget.model.getPreference("navType");
