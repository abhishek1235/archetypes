...
8. Test Orchestrator by opening the Orchestrator configuration URL in a browser: http://localhost:7777/portalserver/orchestrator/configuration (pay attention to the port number).
