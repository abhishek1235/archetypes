/*global b$, bd, gadgets, lp */

/**
 * Backbaase Launchpad Carousel container
 *
 * Gives fading or sliding transition effect between the container's areas
 *
...
(function(window, b$, bd, gadgets, lp, $) {
    ...
    /**
     * Carousel Container definition
     */
    var NS = b$.bdom.getNamespace("http://backbase.com/2012/portalView");
    var Container = NS.classes.container;
    NS.registerElement("CarouselContainer", Container.extend(function(bbDocument, namespaceURI, localName, node) {

        Container.call(this, bbDocument, namespaceURI, localName, node);
        this.isPossibleDragTarget = true;
    }, {
        /**
         * Creates the carousel behavior
         */
        readyHTML: function() {
