define("launchpad/lib/payments/iban-input", [
    'jquery',
    'angular',
    'launchpad/lib/common/util',
    'launchpad/lib/payments/payments-module',
    'launchpad/lib/payments/iban-model',
    'launchpad/support/angular/angular-ui-bootstrap'
], function($, angular, util, paymentsModule) {

    'use strict';

    paymentsModule.directive('lpIbanInput', ['$templateCache', '$timeout', 'IbanModel', 'widget', function($templateCache, $timeout, IbanModel, widget) {
            ...
            template: 
                '<div class="lp-iban">' +
                    ...
                    '<div class="lp-iban-input" ng-class="{\'has-success\': ibanModel.valid && iban.value.length, \'has-error\': !ibanModel.valid && iban.value.length,  \'has-feedback\': iban.value.length}">' +
                        '<input name="ibanInputField" required="required" type="input" class="form-control" lp-input-overflow="lp-input-overflow" ng-model="iban.value"  aria-required="true" ' +
