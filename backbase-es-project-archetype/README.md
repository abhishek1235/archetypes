...
5. Test Launchpad Theme by opening the main theme CSS in a browser: [http://localhost:7777/portalserver/static/themes/default/base.less](http://localhost:7777/portalserver/static/themes/default/base.less) (pay attention to the port number).  
...
8. Test Orchestrators by opening the Orchestrator configuration URL in a browser: [http://localhost:8083/portalserver/orchestrator/configuration](http://localhost:8083/portalserver/orchestrator/configuration) (pay attention to the port number).  
