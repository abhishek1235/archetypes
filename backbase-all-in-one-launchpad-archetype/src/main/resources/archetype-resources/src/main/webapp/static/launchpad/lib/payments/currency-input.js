define("launchpad/lib/payments/currency-input", [
	"jquery",
    "angular",
    "launchpad/lib/payments/payments-module"], function($, angular, paymentsModule) {

    "use strict";

    paymentsModule

    .value('currencyMaxLength', 15)

    .directive("lpInputCurrency", ['currencyMaxLength', function(currencyMaxLength) {
        return {
            restrict: 'A',
            require: 'ngModel',
