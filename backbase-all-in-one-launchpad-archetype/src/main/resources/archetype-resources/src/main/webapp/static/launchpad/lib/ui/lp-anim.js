...
require([
	"jquery",
    "launchpad/support/transitn/transitn"
    ...
    lp.anim = {
        ...
        _maximize: function($widget, $area) {
            ...
            var duration = '.4s';
            var $title = jQuery('.lp-springboard-tile-title', $widget);
            var $icon =  jQuery('.lp-springboard-tile-icon', $widget);

            $area.addClass('lp-animating').css({zIndex: 2});
