/*global b$, bd, gadgets, lp, console, require */
 ...
 */
(function(window, b$, bd, gadgets, lp, $) {
     ...
     * @constant {String}
     */
    var SPRINGBOARD_CHROME = "$(contextRoot)/static/launchpad/chromes/springboard/chrome-springboard.html";
    ...
    var selectors = {
        ...
        FREE_AREA_HOLDER: ".lp-springboard-area-holder:not(.lp-springboard-occupied)"
    };
    ...
    NS.registerElement("SpringboardContainer", Container.extend(function(bbDocument, namespaceURI, localName, node) {
        ...
        /**
         * Initializes the springboard manager and renders the html
         */
        ...
        /**
         * Kicks off various things once the html is ready
         */
        readyHTML: function() {
            ...
            window.setTimeout(function() {
                ...
                self.allowPersonalize = self.$body.data("allow-personalize");
        ...
        _restore: function($widget, $area) {
            ...
            // call animation
            lp.anim._restore($widget, $area, restoredPosition);
