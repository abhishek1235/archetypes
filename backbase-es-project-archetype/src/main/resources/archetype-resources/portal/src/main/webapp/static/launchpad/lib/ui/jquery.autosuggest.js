...
(function (factory) {
	...
	if (typeof define === "function" && define.amd) {
		...
		define("launchpad/lib/ui/jquery.autosuggest",["jquery"], factory);
	} else {
		// Browser globals
		factory(jQuery);
	}
	...
	Autocomplete.prototype = {
		...
		initialize: function () {
			...
			container.on("click.autosuggest", suggestionSelector, function () {
			...
			self.el.on("blur.autosuggest", function (e) { self.killerFn(e); });
