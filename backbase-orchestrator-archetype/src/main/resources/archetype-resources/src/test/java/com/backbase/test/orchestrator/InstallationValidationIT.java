package com.backbase.test.orchestrator;
...
public class InstallationValidationIT {
    ...
    public void basicValidation() throws IOException {
        ...
        String url = "http://localhost:${orchestrator.port}/orchestrator-webapp/configuration";
        ...
        adminClient.getState().setCredentials(new AuthScope("localhost", ${orchestrator.port}, AuthScope.ANY_REALM), defaultcreds);
