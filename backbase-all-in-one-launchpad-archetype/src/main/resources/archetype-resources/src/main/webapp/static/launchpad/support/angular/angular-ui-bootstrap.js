...
angular.module("template/dropdown/dropdown.html", []).run(["$templateCache", function($templateCache) {
  $templateCache.put("template/dropdown/dropdown.html",
    ...
    "            <dropdown-option option=\"option\" template-url=\"templateUrl\" multiple=\"multiple\"></dropdown-option>\n" +
    "        </li>\n" +
...
"<div class=\"btn-group dropdown\" ng-keydown=\"onKeydown($event)\" is-open=\"isopen\" role=\"combobox\" aria-activedescendant=\"{{activeOption.id}}\">\n" +
    "    <button tabindex=\"0\" type=\"button\" class=\"btn dropdown-toggle\" ng-class=\"['btn-' + (type || 'default'), size && ('btn-' + size)]\" ng-disabled=\"isDisabled\" style=\"width:100%;\" aria-activedescendant=\"{{activeOption.id}}\">\n" +
