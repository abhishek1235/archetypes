...
H2 is the default database. Refer to the reference documentation for full details on how to [move to a database of your choice if required](https://my.backbase.com/doc-center/manuals/portal/inst_publ.html#inst_publ_database).

The reason why you would want to create your own version of Orchestrator and therefore use this archetype is if you really need to customize Orchestrator according to your special needs. The most common reason for modifications is the creation of custom publishing event processors.

##Usage
Follow the steps below to get started with this archetype. Some of these steps refer to [Backbase Development Setup](https://my.backbase.com/doc-center/manuals/portal/inst_devl.html) or [Install Orchestrator](https://my.backbase.com/doc-center/manuals/portal/inst_publ.html). You should get familiar with these topics before you start using this archetype.
...
Note that both Jetty and Tomcat use the 8083 port by default. In case you need to choose a different port since you maybe already have another process runing on port 8083, make necessary changes in jetty and tomcat plugins within POM file before you run Orchestrator.
5. Test Orchestrator by opening the Orchestrator configuration URL in a browser: http://localhost:8083/orchestrator-webapp/configuration (pay attention to the port number). Use admin/admin to authenticate.
